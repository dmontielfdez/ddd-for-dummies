...
{
    public static function create(FoodId $foodId, string $name, int $proteins, int $fats, int $carbs, FoodPortionType $portionType, int $amount): Food
    {
        return Food::create($foodId, $name, $proteins, $fats, $carbs, new FoodPortion($portionType, $amount));
    }
